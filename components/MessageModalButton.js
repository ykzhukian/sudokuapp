    ...
    return (
      <TouchableWithoutFeedback
        ...
        <View style={style.buttonWrapper}>
          ...
          <View style={[style.buttonShadow, (this.props.cancel ? style.cancelShadow : [])]} />
          <View style={[style.reflection, (this.state.pressed ? {top: 7} : [])]} />
          <View style={[style.reflectionLarge, (this.state.pressed ? {top: 7} : [])]} />
          <View style={[style.reflectionRound, (this.state.pressed ? {top: 7} : [])]} />
        </View>
      </TouchableWithoutFeedback>
    )
  }
