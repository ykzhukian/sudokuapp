        ...
        <ImageBackground source={backgroundSrc} style={style.bg}
          ...
          {this.state.buttons ? (
            <View style={{flexDirection: 'row', justifyContent: 'space-between', width: 170}}>
              <ControlButton active buttonFunction={() => this.back()} icon={require('../assets/img/close.png')} />
              <ControlButton active buttonFunction={() => this.screenshotPrepare()} icon={require('../assets/img/save.png')} />
              <ControlButton active buttonFunction={() => this.share()} icon={require('../assets/img/clear.png')} />
            </View>
          ) : (
